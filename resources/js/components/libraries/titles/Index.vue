    ...
    <div class="lib-page">
        ...
        <div class="lib-header">
            <div class="lib-header__left">
                ...
                <div>
                    <h5 class="lib-header__title">Title Management</h5>
                    <p class="lib-header__subtitle">Manage employee titles and designations</p>
                </div>
            </div>
        ...
        <div class="lib-card">
            ...
            >
                ...
                <template v-slot:item.abbreviation="{ item }">
                    <div class="lib-table__cell">
                        ...
                        <span class="lib-table__abbr">{{ item.abbreviation }}</span>
                    </div>
                </template>
                ...
                <template v-slot:no-data>
                    <div class="lib-empty">
                        ...
                        <p class="lib-empty__title">No titles found</p>
                        <p class="lib-empty__sub">Get started by creating your first title</p>
            ...
            <div class="lib-pagination" v-if="pagination && pagination.total > 0">
                ...
                <div class="lib-pager">
                    <button class="lib-pager__btn" :disabled="query.page <= 1" @click="query.page--; getTitles()">
                        <v-icon icon="mdi-chevron-left" size="18" />
                    </button>
                    <span class="lib-pager__current">{{ query.page }}</span>
                    <button class="lib-pager__btn" :disabled="query.page >= (pagination.last_page || 1)" @click="query.page++; getTitles()">
