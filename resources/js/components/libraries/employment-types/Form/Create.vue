    ...
    <v-dialog v-model="show_form_modal" max-width="480px" persistent>
        <div class="et-modal">
            ...
            <div class="et-modal__header">
                <div class="et-modal__header-left">
                    <div class="et-modal__icon">
                        <v-icon
                    ...
                    <div>
                        <p class="et-modal__eyebrow">Employment Type Management</p>
                        <h6 class="et-modal__title">{{ dialogTitle }}</h6>
                    </div>
                </div>
                <button class="et-modal__close" @click="close()">
            ...
            <div class="et-modal__body">
                <!-- Name -->
                <div class="et-modal__field">
                    <label class="et-modal__label">
                        Name
                        <span class="et-modal__required">*</span>
                    </label>
                    <div class="et-modal__input-wrap" :class="{ 'is-error': errors['name'] }">
                        <v-icon icon="mdi-briefcase-outline" size="16" class="et-modal__input-icon" />
                        <input
                            v-model="form.name"
                            type="text"
                            placeholder="e.g. Regular"
                            class="et-modal__input"
                            @keyup.enter="save()"
                            autofocus
                        />
                    </div>
                    <p v-if="errors['name']" class="et-modal__error">
                ...
                <!-- Description -->
                <div class="et-modal__field">
                    <label class="et-modal__label">Description</label>
                    <div class="et-modal__input-wrap" :class="{ 'is-error': errors['description'] }">
                        <v-icon icon="mdi-text" size="16" class="et-modal__input-icon" />
                        <input
                    ...
                    <p v-if="errors['description']" class="et-modal__error">
                        <v-icon icon="mdi-alert-circle-outline" size="12" />
            ...
            <div class="et-modal__footer">
                <button class="et-modal__btn et-modal__btn--cancel" :disabled="is_loading" @click="close()">
                    Cancel
                </button>
                <button
                    class="et-modal__btn et-modal__btn--save"
...
.et-modal__input-wrap:focus-within {
    border-color: #1fbfb8;
    box-shadow: 0 0 0 3px rgba(31, 191, 184, 0.12);
    background: rgba(31, 191, 184, 0.04);
}

.et-modal__input-wrap.is-error {
    border-color: #f87171;
    box-shadow: 0 0 0 3px rgba(248, 113, 113, 0.1);
}

.et-modal__input-icon {
    color: #1fbfb8;
    flex-shrink: 0;
    opacity: 0.7;
}

.et-modal__input-wrap:focus-within .et-modal__input-icon {
    opacity: 1;
}
...
.et-modal__btn:disabled {
    opacity: 0.4;
    cursor: not-allowed;
}

.et-modal__btn--cancel {
    background: rgba(255, 255, 255, 0.06);
    color: #8aa0d7;
    border: 1px solid rgba(108, 143, 214, 0.2);
}

.et-modal__btn--cancel:hover:not(:disabled) {
...
.et-modal__btn--save:hover:not(:disabled) {
    box-shadow: 0 4px 18px rgba(31, 191, 184, 0.5);
    transform: translateY(-1px);
}

.et-modal__btn--save:active:not(:disabled) {
