...
/*
 * Note: down() intentionally mirrors the previous migration
 * (2026_07_02_133849_apply_grace_threshold_to_attendance_undertime_view)
 * minus the TIME_FORMAT second-stripping in the `resolved` CTE.
 */
